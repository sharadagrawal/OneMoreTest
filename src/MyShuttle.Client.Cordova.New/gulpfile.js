...
gulp.task('beforeBuild', ['bower', 'less', 'templatecache', 'typescript']);

gulp.task('test', ['typescript', 'typescript-tests'], function () {
...
gulp.task('clean-typescript', function (done) {
    clean('./www/scripts/appBundleGulp.js', done);
});
