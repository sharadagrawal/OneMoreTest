...
STORED AS TEXTFILE LOCATION 'wasb://myshuttledata@[StorageAccountName].blob.core.windows.net/tripdata/'
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE LOCATION 'wasb://myshuttledata@[StorageAccountName].blob.core.windows.net/accelerometer/'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE LOCATION 'wasb://myshuttledata@[StorageAccountName].blob.core.windows.net/compass/'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE LOCATION 'wasb://myshuttledata@[StorageAccountName].blob.core.windows.net/OBD/'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE LOCATION 'wasb://myshuttledata@[StorageAccountName].blob.core.windows.net/OBD-SecurityBelt/'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE LOCATION 'wasb://myshuttledata@[StorageAccountName].blob.core.windows.net/rfid/'
tblproperties ("skip.header.line.count"="1");
