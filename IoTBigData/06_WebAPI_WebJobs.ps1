...
# .\06_WebAPI_WebJobs.ps1 -ResourceGroupName "myshuttle" -ResourceGroupLocation "West US" -SiteName "aspnetwebjobcas" -SqlServerName "myshuttlesqlserver" -SqlServerAdminLogin "myshuttleadmin" -SqlServerAdminPassword "myshuttle1234!" -DocumentDBId "myshuttle2" -DocumentDBAccessKey "+ciSgncwL5qbGsu/Jg9GY3ynr2LIYrGvAcbUgSrGtodAnlealjUodbpP0FwO5xvU15g/NLKQXP3qiI/oKnhMrw=="
