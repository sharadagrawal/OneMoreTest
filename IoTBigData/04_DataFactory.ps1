...
# powershell .\04_DataFactory.ps1 -DataFactoryName MyShuttle2 -ResourceGroupName MyShuttle2 -StorageAccountName myshuttlestorage2 -Location 'West US' -SqlServerName myshuttle2 -SqlDatabaseName myshuttle2 -SqlServerAdminLogin myshuttle -SqlServerAdminPassword shuttleP2ssw0rd -HDInsightClusterName myshuttle2 -HDInsightClusterUser admin -HDInsightClusterPassword "MyShuttle0)"
