...
# .\03_HDInsight.ps1  -HDInsightClusterName myclustertest -ClusterNodes 1 -HDInsightClusterUser admin -HDInsightClusterPassword 'MyShuttle0)' -StorageAccountName myshuttlestorage2 -Location 'East US'
